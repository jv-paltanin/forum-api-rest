...
import br.com.foursys.forum.controller.dto.DetalheDoUsuarioDto;
...
/**
 * Classe responsável por controlar os curso do forum de dúvidas
 * 
 * @author João Victor
 * @since 17/05/2021
 * @version 1.0
...
public class UsuarioController {
	...
	public ResponseEntity<DetalheDoUsuarioDto> detalhar(@PathVariable Long id) {
		...
		if (usuario.isPresent()) {
			return ResponseEntity.ok(new DetalheDoUsuarioDto(usuario.get()));
		}
