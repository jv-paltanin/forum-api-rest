...
import br.com.foursys.forum.controller.dto.DetalheDoCursoDto;
...
public class CursoController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<DetalheDoCursoDto> detalhar(@PathVariable Long id) {
		Optional<Curso> curso = cursoRepository.findById(id);
		if (curso.isPresent()) {
			return ResponseEntity.ok(new DetalheDoCursoDto(curso.get()));
		}
